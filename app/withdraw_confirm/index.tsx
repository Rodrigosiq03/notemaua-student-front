...
export default function WithdrawConfirm() {
    ...
    const { withdrawCreated } :any = useContext(WithdrawContext)
    ...
    return (
        <Container>
            ...
            <Content>
                ...
                <ContainerLinks>
                    <LinkText><Link style={{color:"#545454", fontWeight:"500"}} href="/(tabs)/withdraw">Sair </Link><Icon name="sign-out-alt" size={20} color={'#545454'} /></LinkText>
                </ContainerLinks>
            </Content>
