import { ActivityIndicator, Keyboard, Modal, Platform, StyleSheet, Text, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native";
...
import { ContainerLinks, LinkText } from "../../styles";
...
import { BackContainer, ScannerBar, ScannerContainer } from "../../camera_screen/styles";
import React from "react";

export default function WithdrawNotebook() {
    ...
    async function PostWithdraw() {
        ...
        if(withdraw) {
            ...
            setTimeout(() => {
                setLoading(false)
                router.navigate('/withdraw_confirm')
            }, 3000);
        }else{
            setTimeout(() => {
                setLoading(false)
        ...
        {cameraModal ?
            <Modal>
                <SafeAreaView style={{flex:1, justifyContent:'center'}}>
                    <CameraView onBarcodeScanned={handleBarCodeScanned} style={{flex: 1, justifyContent:'center', alignItems:'center'}} facing={facing}>
                        <BackContainer>
